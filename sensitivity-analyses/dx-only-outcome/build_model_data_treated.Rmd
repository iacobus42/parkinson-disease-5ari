...
```{r data-load}
enrollments <- read_rds("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/candidate_treated_dx_only.rds")
...
reduce_dx <- function(args) {
  ...
  log_path <- glue::glue("~/extraction_logs/{source}_{year}_dx_only.txt")
  ...
  write_rds(first_dx, glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/first_dx/{source}_{year}_dx_only.rds"))
  write_rds(inpatient_volume, glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_inpatient_dx_only.rds"))
  write_rds(outpatient_volume, glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_outpatient_dx_only.rds"))
  write_rds(outpatient_dx_volume, glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_outpatient_dx_dx_only.rds"))
  write_rds(outpatient_ndx, glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_outpatient_ndx_dx_only.rds"))
...
for (source in c("ccae", "mdcr")) {
  for (year in stringr::str_pad(1:17, width = 2, pad = "0")) {
    dx_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/first_dx/{source}_{year}_dx_only.rds"))
    inpatient_volume_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_inpatient_dx_only.rds"))
    outpatient_volume_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_outpatient_dx_only.rds"))
    outpatient_dx_volume_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_outpatient_dx_dx_only.rds"))
    ndx_list[[i]] <- read_rds(glue::glue("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/volume/{source}_{year}_outpatient_ndx_dx_only.rds"))
    i <- i + 1
    p$tick()
  }
}
...
write_rds(model_data,
          "/Shared/lss_jsimmeri_backup/data/tz-5ari-final/treated_model_data_dx_only.rds")
```
