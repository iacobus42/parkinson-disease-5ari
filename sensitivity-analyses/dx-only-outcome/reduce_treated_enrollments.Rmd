...
```{r load-pd-dates}
pd_dates <- read_rds("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/first_pd_date_dx_only.rds")
```
...
write_rds(two_or_more,
          "/Shared/lss_jsimmeri_backup/data/tz-5ari-final/candidate_treated_dx_only.rds")
```
