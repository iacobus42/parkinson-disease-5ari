...
```{r load-model-data}
treated <- read_rds("/Shared/lss_jsimmeri_backup/data/tz-5ari-final/treated_model_data_dx_only.rds")
```
...
write_rds(
  tz_tam_full,
  "/Shared/lss_jsimmeri_backup/data/tz-5ari-final/matching_candidates/tz_tam_dx_only.rds")
write_rds(
  tz_5ari_full,
  "/Shared/lss_jsimmeri_backup/data/tz-5ari-final/matching_candidates/tz_5ari_dx_only.rds")
write_rds(
  tam_5ari_full,
  "/Shared/lss_jsimmeri_backup/data/tz-5ari-final/matching_candidates/tam_5ari_dx_only.rds")
```
